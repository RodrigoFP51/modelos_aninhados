...
Neste último gráfico, é possível ver que o produto per capita se relaciona positivamente com a expectativa de vida.
Porém, uma regressão linear indica coeficientes diferentes para cada continente.
...
df_models_unnested %>% 
  ...
  facet_wrap(vars(continent), scales = "free", ncol = 2) 
```
